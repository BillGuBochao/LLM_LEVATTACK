...
def prepare_casp_data(casp_path: str, output_dir: str, n_rows=5000, digits=5):
    ...
    df_subset = df.sample(n=n_rows * 2, random_state=42).reset_index(drop=True)
    member_df, non_member_df = train_test_split(df_subset, train_size=n_rows, random_state=42)
