...
class REaLTabFormer:
    ...
    def sample(
        ...
        processor: bool = False,   # Whether we want to enable to logit processor
        tendency: Optional[float] = None,  # This is used combined with processor
        **generate_kwargs,
    ) -> pd.DataFrame:
        ...
        if self.model_type == ModelType.tabular:
            ...
            tabular_sampler = TabularSampler.sampler_from_model(
                ...
                processor = processor,   # Processor controls whether we want to enable logit processor
